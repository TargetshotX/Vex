...
//Left Motors:
motor_group(leftDrive1,leftDrive2,leftDrive3),

//Right Motors:
motor_group(rightDrive1,rightDrive2,rightDrive3),
...
void autonomous(void) {
  ...
  switch(current_auton_selection){  
    case 0:
      Near_Side_WinPoint(); //This is the default auton, if you don't select from the brain.
